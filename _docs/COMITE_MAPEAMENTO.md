...
| **14** | Casa/FPG — acumulado YTD | `DRE_Historico.xlsx` | `Base YTD`, CC=FPG. Apresentado desde ago/26; `Deduções` = DEDUÇÕES E IMPOSTOS da base (saía zerada; jun/26 −5.666) | auto |
