...
FONTES = {
    ...
    "Índice eficiência": ("2 · Receptoras",
        ...
        "Vazias ÷ doadoras (CATEGORIA = DOADORA no roster). Confirmado contra o histórico: 21/08 tinha doadoras=12 e ciclando=10 ao mesmo tempo, com índice 2,5 — só 30÷12 fecha. 'Doadoras ciclando' é indicador próprio, manual, não entra nesta conta."),
