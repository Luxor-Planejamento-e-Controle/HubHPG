...
FONTES = {
    ...
    "Índice eficiência": ("2 · Receptoras",
        "ARRENDAMENTOS E RECEPTORAS · ANIMAIS\nESTACAO DE MONTA · PLANEJAMENTO",
        "Vazias ÷ doadoras (linhas da aba PLANEJAMENTO da estação de monta, não CATEGORIA=DOADORA do plantel). Confirmado contra o histórico: 21/08 tinha doadoras=12 e ciclando=10 ao mesmo tempo, com índice 2,5 — só 30÷12 fecha. 'Doadoras ciclando' é indicador próprio, manual, não entra nesta conta."),
